...
var authentication = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var apiKey, validation, company;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                apiKey = req.headers["x-api-key"];
                validation = schemas_1.authSchema.validate(apiKey);
                if (validation.error) {
                    throw new exceptions_1.default(statusCode_1.StatusCode.BadRequest_400, "Api key não enviada ou mal formatada!");
                }
                return [4 /*yield*/, (0, companyRepository_1.findByApiKey)(apiKey)];
            case 1:
                company = _a.sent();
                if (!company) {
                    throw new exceptions_1.default(statusCode_1.StatusCode.Anauthorized_401, "Api Key não autorizada!", "Erro de autorização");
                }
