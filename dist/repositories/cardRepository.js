...
function find() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_1.default.query("SELECT * FROM cards")];
                case 1:
                    result = _a.sent();
...
function findById(id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_1.default.query("SELECT * FROM cards WHERE id=$1", [id])];
                case 1:
                    result = _a.sent();
...
function findByTypeAndEmployeeId(type, employeeId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_1.default.query("SELECT * FROM cards WHERE type=$1 AND \"employeeId\"=$2", [type, employeeId])];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, result.rows[0]];
            }
...
function remove(id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            database_1.default.query("DELETE FROM cards WHERE id=$1", [id]);
            return [2 /*return*/];
        });
    });
}
