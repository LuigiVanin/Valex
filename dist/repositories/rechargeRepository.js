...
function findByCardId(cardId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, database_1.default.query("SELECT * FROM recharges WHERE \"cardId\"=$1", [cardId])];
                case 1:
                    result = _a.sent();
...
function insert(rechargeData) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            database_1.default.query("INSERT INTO recharges (\"cardId\", amount) VALUES ($1, $2)", [cardId, amount]);
            return [2 /*return*/];
        });
    });
}
